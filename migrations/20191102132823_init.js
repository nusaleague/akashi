exports.up = async knex => {
  await knex.schema.createTable('mascot', table => {
    ...
    table.string('short_name', 24).notNullable();

    table.string('comp', 16).notNullable();
  ...
  await knex.schema.createTable('mascot_season', table => {
    ...
    table.string('division', 16).notNullable();
  ...
  await knex.schema.createTable('match', table => {
    ...
    table.string('stage', 4).notNullable();
  });
  ...
  await knex.schema.createTable('user', table => {
    ...
    table.string('display_name', 24).notNullable();
  ...
  await knex.schema.createTable('user_social', table => {
    table.string('provider', 8).notNullable();
  ...
  await knex.schema.createTable('vote_fixture', table => {
    ...
    table.string('season', 8).notNullable();
